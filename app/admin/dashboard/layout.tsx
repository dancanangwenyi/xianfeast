      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <motion.div
            ...
            animate={{ x: 0 }}
            exit={{ x: -300 }}
            className="fixed left-0 top-0 h-full w-64 bg-white shadow-xl border-r border-slate-200"
          >
      ...
      <div className="flex h-screen">
        ...
        <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:z-50">
          <div className="flex flex-col flex-grow bg-white border-r border-slate-200 shadow-sm">
            {/* Header */}
            <div className="flex items-center space-x-3 px-4 py-3 border-b border-slate-200">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 font-medium">Super Admin</p>
              </div>
            </div>

            {/* Navigation */}
            <nav className="flex-1 px-3 py-4 space-y-1">
              <div className="text-xs font-semibold text-slate-600 uppercase tracking-wider mb-2 px-3">
                Navigation
              </div>
              {navigation.map((item) => {
                const isActive = pathname === item.href
            ...
            <div className="border-t border-slate-200 p-4">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-600 truncate">dancangwe@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="hidden md:block">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 w-64 bg-slate-50 border-slate-200 focus:bg-white focus:border-red-300 focus:ring-red-200 text-slate-900 placeholder:text-slate-500"
                    />
                  </div>
                </div>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="outline" size="sm" className="border-slate-200 text-slate-700 hover:bg-slate-50 hover:text-slate-900">
                      Quick Actions
                    </Button>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent align="end" className="w-56 bg-white border-slate-200 shadow-lg">
                    <DropdownMenuLabel className="text-slate-900">Quick Actions</DropdownMenuLabel>
                    <DropdownMenuSeparator className="bg-slate-200" />
                    <DropdownMenuItem className="text-slate-700 hover:bg-slate-100 hover:text-slate-900">
