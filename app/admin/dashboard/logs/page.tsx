            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="font-medium text-green-800">Successful Events</span>
                </div>
                <div className="text-2xl font-bold text-green-900">
                  {logs.filter(l => l.level === "success" && new Date(l.timestamp) > new Date(Date.now() - 24 * 60 * 60 * 1000)).length}
                </div>
                <div className="text-sm text-green-600">In last 24h</div>
              </div>
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="font-medium text-blue-800">User Actions</span>
                </div>
                <div className="text-2xl font-bold text-blue-900">
                  {logs.filter(l => l.eventType.includes("user") && new Date(l.timestamp) > new Date(Date.now() - 24 * 60 * 60 * 1000)).length}
                </div>
                <div className="text-sm text-blue-600">User activities</div>
              </div>
            </div>

            <div className="p-4 bg-slate-50 rounded-lg">
              <h4 className="font-medium mb-2">Most Frequent Events</h4>
